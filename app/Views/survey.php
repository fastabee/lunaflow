...
<div id="modal-survey" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
  ...
  <div class="container">
    ...
    <form action="<?= base_url('insert/survey') ?>" method="post" enctype="multipart/form-data"
    class="login__form">
    <input type="text" name="id" value="<?php echo @$data->id?>" hidden>

    <h4 style="margin-top: 10px; padding-left: 20px;" >Gejala Pertama</h4>
    <div class="card">
...
<h4 style="margin-top: 10px; padding-left: 20px;" >Gejala Kedua</h4>
<div class="card">
  <h5>Apakah nyeri haid Anda muncul setiap siklus haid?</h5>

    <div class="radio-group">
      <input type="radio" id="yes" name="7" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="7" value="0">
      <label for="no">Tidak</label>
    </div>
...
<div class="card">
  <h5>Apakah nyeri ini membuat Anda sulit menjalani aktivitas sehari-hari</h5>
  
    <div class="radio-group">
      <input type="radio" id="yes" name="8" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="8" value="0">
      <label for="no">Tidak</label>
    </div>
...
<div class="card">
  <h5>Apakah nyeri disertai gejala lain, seperti mual, muntah, diare, atau pusing?</h5>
  
    <div class="radio-group">
      <input type="radio" id="yes" name="9" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="9" value="0">
      <label for="no">Tidak</label>
    </div>
...
<div class="card">
  <h5>Apakah anda mengalami perdarahan haid yang banyak atau berkepanjangan</h5>
  
    <div class="radio-group">
      <input type="radio" id="yes" name="10" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="10" value="0">
      <label for="no">Tidak</label>
    </div>
...
<div class="card">
  <h5>Apakah siklus haid anda teratur dalam 1 bulan?</h5>
  <
    <div class="radio-group">
      <input type="radio" id="yes" name="11" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="11" value="0">
      <label for="no">Tidak</label>
    </div>
...
<div class="card">
  <h5>Apakah ada anggota keluarga Anda yang memiliki riwayat penyakit rahim seperti kista, mioma, atau endometriosis?</h5>
  
    <div class="radio-group">
      <input type="radio" id="yes" name="12" value="1">
      <label for="yes">Iya</label>
      
      <input type="radio" id="no" name="12" value="0">
      <label for="no">Tidak</label>
    </div>
