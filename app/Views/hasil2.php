...
<body style="background-color: pink;">
  <div class="container">
    ...
    <p style="<?= (isset($hasil->status) && $hasil->status > 0) ? '' : 'display: none;'  ?> font-style: italic; margin-bottom: 10px;     padding-left: 20px; padding-right: 20px;">Terdapat Indikasi dysmenorrhea !</p>
    <div class="card">
